...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        // Repay collateral_WBTC to flash loan debt WBTC/USDT pool directly
        ...
        // Swap remaining WBTC from repay to ETH to count profit
        uint profit = WBTC.balanceOf(address(this));
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), profit);
        uint amountOut_WETH = getAmountOut(profit, reserve_WBTC_Pool2, reserve_WETH_Pool2);
        uniswapV2Pair_WBTC_WETH.swap(0, amountOut_WETH, address(this), "");
